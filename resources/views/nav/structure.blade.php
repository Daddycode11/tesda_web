...
@section('content')
<section class="max-w-5xl mx-auto px-6 py-12 text-gray-800 space-y-4">
    <h1 class="text-3xl font-bold text-blue-800">Organizational Structure</h1>
    <p>
        TESDA is attached to the Department of Labor and Employment (DOLE).  
        Headquarters is in Taguig, Metro Manila.
    </p>
    <p>
        As of 2024, TESDA has approximately 4,128 employees.  
    </p>
    {{-- You can include an org chart image --}}
    <div class="mt-6">
        <img src="{{ asset('images/tesda-structure.png') }}" alt="TESDA Organizational Structure"
