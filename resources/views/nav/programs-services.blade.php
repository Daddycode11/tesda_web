...
<section class="max-w-6xl mx-auto px-6 py-12 text-gray-800">
    <h1 class="text-3xl font-bold text-blue-800 mb-6">Programs & Services</h1>
    <p class="mb-6">
        TESDA supports multiple modalities of technical education and skills training: school-based, center-based,
        community-based, and enterprise-based programs.
    </p>
            ...
            <div class="bg-white rounded shadow p-4 flex flex-col items-center">
                @if($program->image)
                    <img src="{{ asset('storage/programs/'.$program->image) }}" 
                         alt="{{ $program->name }}" class="w-full h-48 object-cover rounded mb-4">
                @else
                ...
                <p class="text-gray-700 text-sm">{{ $program->description }}</p>
            </div>
        @empty
            <p class="text-gray-600 col-span-full">No programs or services available at the moment.</p>
        @endforelse
    </div>
</section>