...
@section('content')
<section class="max-w-4xl mx-auto px-6 py-12 text-gray-800">
    <h1 class="text-3xl font-bold mb-6 text-blue-800">Feedback</h1>
    <p class="text-lg mb-6">We value your feedback. Please share your thoughts, suggestions, or experiences with us.</p>
