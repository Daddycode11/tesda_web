...
<section class="max-w-5xl mx-auto px-6 py-12 text-gray-800">
    <h1 class="text-3xl font-bold mb-4 text-blue-800">Contact Us</h1>
    <p class="text-lg mb-6">Have questions or need assistance? Reach out through the following channels:</p>

    <div class="space-y-4">
        <p><strong>Address:</strong> TESDA Provincial Office, Occidental Mindoro</p>
        <p><strong>Phone:</strong> (043) 123-4567</p>
        <p><strong>Email:</strong> <a href="mailto:info@tesdaoccidental.com" class="text-blue-600 underline">info@tesdaoccidental.com</a></p>
        <p><strong>Facebook:</strong> <a href="#" class="text-blue-600 underline">facebook.com/TESDAOccidentalMindoro</a></p>
    </div>
</section>
@endsection
