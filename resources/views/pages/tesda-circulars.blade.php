...
<table class="table-auto w-full border">
    <thead>
        <tr class="bg-gray-200">
            <th class="px-4 py-2">Document Series</th>
    ...
    <tbody>
        ...
        <tr class="border-t">
            <td class="px-4 py-2">{{ $circular['series'] }}</td>
            <td class="px-4 py-2">{{ $circular['subject'] }}</td>
            <td class="px-4 py-2">
                @if($circular['file'] !== '#')
                <a href="{{ $circular['file'] }}" target="_blank" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700">
                    Download
                </a>
                @else
                N/A
