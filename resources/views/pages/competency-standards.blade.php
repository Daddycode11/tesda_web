...
@section('content')
<!-- Page Header -->
<section class="page-header py-8 bg-gray-100 border-b">
    <div class="container mx-auto text-center">
        <h1 class="text-3xl md:text-4xl font-bold text-gray-800">Competency Standards Development</h1>
    </div>
</section>

<!-- Page Content -->
<section class="page-content py-12">
    <div class="container mx-auto max-w-4xl space-y-6 text-gray-700">
        <p class="leading-relaxed text-lg">
            TESDA develops competency standards for middle-level skilled workers. These are structured as units of competency containing descriptors for acceptable work performance. The units are packaged into qualifications corresponding to critical jobs and occupations in priority industry sectors. Each qualification aligns with a specific level in the Philippine TVET Qualifications Framework (PTQF).
        </p>

        <p class="leading-relaxed text-lg">
            The competency standards and qualifications, together with training standards and assessment arrangements, form the National Training Regulations (TR) promulgated by the TESDA Board. These TRs serve as the foundation for registration and delivery of TVET programs, competency assessment and certification, and curriculum development for each specific qualification.
        </p>

        <h2 class="text-2xl font-semibold mt-8 mb-4">Promulgated Training Regulations (TR)</h2>
        <ul class="space-y-3 list-disc list-inside">
            @foreach($promulgatedTRs as $tr)
                <li>
                    @if($tr['link'] != '#')
                        <a href="{{ $tr['link'] }}" target="_blank" class="text-blue-600 hover:text-blue-800 font-medium transition">
                            {{ $tr['title'] }}
                        </a>
                        <span class="ml-2 inline-block px-2 py-1 text-xs font-semibold bg-gray-200 rounded">PDF</span>
                    @else
                        <span>{{ $tr['title'] }}</span>
                    @endif
                </li>
        ...
        <h2 class="text-2xl font-semibold mt-8 mb-4">Other Competency Standards Resources</h2>
        <p class="text-lg leading-relaxed">
            For more details about competency standards, assessment arrangements, and qualification levels, please consult the TESDA official website or the relevant TR documents.
        </p>
    </div>
</section>
