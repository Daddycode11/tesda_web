...
<div class="relative w-full h-screen sm:h-[40rem] lg:h-[50rem]">
    <img src="{{ asset('images/transparency-seal-hero.jpg.jpg') }}" alt="Transparency Seal Hero" class="absolute inset-0 w-full h-full object-cover">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <p class="text-gray-700 dark:text-gray-300 mb-4">
        This page contains information about TESDA’s Transparency Seal, in accordance with government transparency requirements.
    </p>

    {{-- Example content from TESDA transparency seal --}}
    <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2 mb-6">
        <li><a href="https://www.tesda.gov.ph/About/TESDA/136" target="_blank" class="text-blue-600 hover:underline">Official Transparency Seal page</a></li>
        <li>Agency profile</li>
        <li>Financial information</li>
        <li>Programs, projects, and activities</li>
        <li>Reports and accountability documents</li>
    </ul>

    {{-- Optional: Image / PDF downloads --}}
    <div class="mt-6">
        <img src="{{ asset('images/transparency-seal-sample.png') }}" alt="Transparency Seal Sample" class="w-full max-w-md rounded-lg shadow-md">
    </div>
</div>
</div>
