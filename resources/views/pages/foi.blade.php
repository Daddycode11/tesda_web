...
@section('title', 'Freedom of Information (FOI)')

@section('content')
<!-- Hero Section -->
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold text- blue leading-tight">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
    ...
    <!-- FOI Manuals / Forms Section -->
    <div>
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">FOI Manuals & Forms</h2>
        <ul class="space-y-2">
            <li>
                <a href="https://tesda.gov.ph/Uploads/File/FOI/new/TESDA_Updated%20FOI%20Manual_2020.PDF" 
                   target="_blank" class="text-blue-600 hover:underline flex items-center">
                    FOI People's Manual
                </a>
            </li>
            <li>
                <a href="https://tesda.gov.ph/Uploads/File/FOI/2025/TESDA_One-Page%20FOI%20Manual-1.pdf" 
                   target="_blank" class="text-blue-600 hover:underline flex items-center">
                    FOI One Page Manual
                </a>
            </li>
            <li>
                <a href="https://tesda.gov.ph/Uploads/File/FOI/2025/TESDA_One-Page%20FOI%20Manual-1%20(Filipino).pdf" 
                   target="_blank" class="text-blue-600 hover:underline flex items-center">
                    The One FOI Page Manual (Filipino)
                </a>
            </li>
            <li>
                <a href="https://tesda.gov.ph/Uploads/File/FOI/3_FOI%20Request%20Form.pdf" 
                   target="_blank" class="text-blue-600 hover:underline flex items-center">
                    FOI Request Form
                </a>
            </li>
            <li>
                <a href="https://tesda.gov.ph/Uploads/File/FOI/FOI%20-%20Schedule%20of%20Fees.pdf" 
                   target="_blank" class="text-blue-600 hover:underline flex items-center">
                    FOI Schedule of Fees
                </a>
            </li>
        </ul>
    </div>
    ...
    <!-- FOI Reports Section -->
    <div>
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">FOI Reports</h2>
        <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
            <li>
                <a href="https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Ftesda.gov.ph%2FUploads%2FFile%2FFOI%2FFOI%2520Reports.xlsx&wdOrigin=BROWSELINK" 
                   target="_blank" class="text-blue-600 hover:underline">
                   Masterlist of the FOI Receiving Officers and Decision Makers
                </a>
            </li>
            <li><a href="#" class="text-blue-600 hover:underline">TESDA FOI Reports for 2024</a></li>
            <li><a href="#" class="text-blue-600 hover:underline">TESDA FOI Reports for 2023</a></li>
            <li><a href="#" class="text-blue-600 hover:underline">TESDA FOI Reports for 2022</a></li>
            <li><a href="#" class="text-blue-600 hover:underline">TESDA FOI Reports for 2021</a></li>
            <li><a href="#" class="text-blue-600 hover:underline">TESDA FOI Reports for 2020</a></li>
            <li><a href="#" class="text-blue-600 hover:underline">TESDA FOI Reports for 2019-2020</a></li>
            <li><a href="#" class="text-blue-600 hover:underline">TESDA FOI Reports for 2018</a></li>
        </ul>
    </div>
</div>
