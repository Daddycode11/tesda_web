...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <!-- Hero / Title -->
    <div class="mb-8">
        <h1 class="text-4xl sm:text-5xl font-bold text-gray-800 dark:text-black-200">
            Downloadable Files
        </h1>
        <p class="text-gray-700 dark:text-gray-300 mt-2">
            Forms and other files available for downloading.
        </p>
    </div>
    ...
    <div class="space-y-4">
        @foreach($files as $file)
            <a href="{{ $file['url'] }}" target="_blank"
               class="flex items-center p-4 bg-gray-100 dark:bg-gray-700 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition">
                <!-- Download SVG Icon -->
                <svg class="w-6 h-6 text-blue-600 flex-shrink-0 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M3 17a2 2 0 002 2h10a2 2 0 002-2v-6h-2v6H5v-6H3v6zM13 9V3H7v6H4l6 6 6-6h-3z"/>
                </svg>
                <span class="text-gray-800 dark:text-gray-200 font-medium">{{ $file['title'] }}</span>
            </a>
        @endforeach
    </div>

    <!-- Optional: TESDA reference link -->
    <div class="mt-8">
        <a href="https://www.tesda.gov.ph/About/TESDA/29" target="_blank" class="text-blue-600 hover:underline">
            Official TESDA Downloadable Files Page
        </a>
    </div>
</div>
