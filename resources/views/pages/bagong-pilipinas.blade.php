...
@section('title', 'Bagong Pilipinas')

@section('content')

<!-- Hero Section -->
<div class="relative w-full bg-gray-100 dark:bg-gray-800 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
        <div class="md:w-1/2 mb-6 md:mb-0">
            ...
            <p class="mt-4 text-lg text-gray-700 dark:text-gray-300">
                TESDA’s initiative to provide Filipinos with quality training, skills development, and employment opportunities.
            </p>
        </div>
        <div class="md:w-1/2 flex justify-center">
            <img src="{{ asset('images/bagong-pilipinas-logo.png') }}" alt="Bagong Pilipinas Logo" class="w-48 h-auto">
        </div>
    </div>
</div>
...
<!-- Programs Section -->
<div class="space-y-4">
    <h2 class="text-3xl font-bold text-gray-800 dark:text-black-200 flex items-center space-x-3">
        <!-- Programs SVG Icon -->
        <svg class="w-8 h-8 flex-shrink-0 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
    ...
    <p class="text-gray-700 dark:text-gray-300">
        TESDA implements a variety of programs under Bagong Pilipinas to improve skills, employment opportunities, and livelihood support.
    </p>
    <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
        <li>Skills training programs for youth and workers</li>
        <li>Livelihood and entrepreneurship support</li>
        <li>Special programs for disadvantaged communities</li>
    </ul>
</div>
...
<div class="space-y-4">
    ...
    <p class="text-gray-700 dark:text-gray-300">
        Keep track of the latest news, announcements, and reports related to Bagong Pilipinas initiatives.
    </p>
    <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
        <li><a href="#" class="text-blue-600 hover:underline">Program schedule updates</a></li>
        <li><a href="#" class="text-blue-600 hover:underline">Success stories and case studies</a></li>
        <li><a href="#" class="text-blue-600 hover:underline">Reports and official documents</a></li>
    </ul>
</div>
...
<div class="space-y-4">
    <h2 class="text-3xl font-bold text-gray-800 dark:text-black-200 flex items-center space-x-3">
        <!-- Links SVG Icon -->
        <svg class="w-8 h-8 flex-shrink-0 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
            <path d="M3.9 12a5 5 0 017.07-7.07l1.41 1.41a1 1 0 01-1.41 1.41L9.56 6.34a3 3 0 00-4.24 4.24l1.42 1.42a1 1 0 01-1.42 1.42L3.9 12zm16.2 0a5 5 0 01-7.07 7.07l-1.41-1.41a1 1 0 011.41-1.41l1.42 1.42a3 3 0 004.24-4.24l-1.42-1.42a1 1 0 011.42-1.42l1.42 1.42zM8.46 11.46l7.08 7.08"/>
        </svg>
        <span>External Links</span>
    </h2>
    <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
        <li>
            <a href="https://www.tesda.gov.ph/About/TESDA/Bagong-Pilipinas" target="_blank" class="text-blue-600 hover:underline">
                Official Bagong Pilipinas page
            </a>
        </li>
        <li>
            <a href="https://pqf.gov.ph/" target="_blank" class="text-blue-600 hover:underline">
